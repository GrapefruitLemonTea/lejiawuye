        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-10">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title">新增捐资表</h3>
                        </div>
                        <div class="panel-body">
                            <form role="form" action="/index.php/Home/Donation/donationAdd" method="post">
                                <div class="form-group">
                                    <label for="exampleInputEmail1">名称</label>
                                    <input type="text" class="form-control" name="title" placeholder="请输入标题名称！">
                                </div>
                                <div class="form-group">
